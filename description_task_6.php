            ...
            <div class="col-md-6">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-content">
                        Необходимо забанить нескольких чуваков, сделать данные полупрозрачными для забаненных</br> 
                        В задаче указано, что нужно использовать клас banned. Но, данного класа нет в стилях. Из-за чего просто добавиляю style="opacity:0.4" к забаненным пользователям.                      
                    </div>
                        <div class="panel-content">
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            <div style="opacity:0.4" class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
