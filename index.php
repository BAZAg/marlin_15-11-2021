<?php
    $items = [
        ...
        [
            ["href"=> "description_task_8.php", "text"=>"Описание"],
            ["href"=> "task_8.html", "text" => "Задача"],
            ["href"=> "solution_task_8.php", "text"=>"Решение"],
            ["href"=> "db_task_8.json", "text"=>"json"]

        ],
        [
            ["href"=> "description_task_9.php", "text"=>"Описание"],
            ["href"=> "task_9.html", "text" => "Задача"],
            ["href"=> "solution_task_9.php", "text"=>"Решение"],
            ["href"=> "db_task_9.json", "text"=>"json"]

        ],
        [
            ["href"=> "description_task_10.php", "text"=>"Описание"],
            ["href"=> "task_10.html", "text" => "Задача"],
        ...
        [
            ["href"=> "description_task_12.php", "text"=>"Описание"],
        ...
        [
            ["href"=> "description_task_14.php", "text"=>"Описание"],
            ["href"=> "task_14.html", "text" => "Задача"],
            ["href"=> "solution_task_14.php", "text"=>"Решение"],
            ["href"=> "db_task_14.json", "text"=>"json"]

        ],
        [
            ["href"=> "description_task_14_1.php", "text"=>"Описание"],
            ["href"=> "task_14_1.html", "text" => "Задача"],
            ["href"=> "solution_task_14_1.php", "text"=>"Решение"]

        ],
        [
            ["href"=> "description_task_15.php", "text"=>"Описание"],
        ...
        [
            ["href"=> "description_task_15_2.php", "text"=>"Описание"],
            ["href"=> "task_15_2.html", "text" => "Задача"],
            ["href"=> "solution_task_15_2.php", "text"=>"Решение"],
            ["href"=> "db_task_15_2.json", "text"=>"json"]
        ]
