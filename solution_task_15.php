<?php
    $images = GetData();
    function GetData(){
        return json_decode(file_get_contents('db_task_15.json'), true);
    }
    function AddData($line){
        $data = GetData();
        $data[] = ["id"=> md5($line), "file"=>$line];
        file_put_contents('db_task_15.json', json_encode($data,true));
    } 
                            ...
                            <div class="panel-content">
                                <div class="panel-content">
                                    <div class="form-group">
                                        <form action="solution_task_15.php" enctype="multipart/form-data" method="POST">
                                            <div class="form-group">
