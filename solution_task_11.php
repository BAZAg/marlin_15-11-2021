<?php
    ...
    function CheckData($email){
        ...
        foreach($items as $item) {
            if (isset($item['email']) AND $item['email'] === $email) return true;
        }
        return false;
    }
    if(isset($_POST["email"])&& isset($_POST["password"])){
        if( CheckData($_POST["email"])) {
            $_SESSION["message"] = "Эта почта занята другим пользователем";
        }
        else {
            AddData(["email"=>$_POST["email"], "password"=> $_POST["password"]]);
        }
    }
?>
<!DOCTYPE html>
                        ...
                        <div class="panel-content">
                            <div class="panel-content">
                                <div class="form-group">
                                    ...
                                    <?php endif;?>
                                    <form action="solution_task_11.php" method="POST">
                                        <div class="form-group">
